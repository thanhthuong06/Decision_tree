...
# ==============================================================================
input_file = "Ket_qua_phan_tich.xlsx"
output_file = "Ket_qua_phan_tich_Chu_de_Truong_Nganh.xlsx"
...
if 'Clean_text' not in df.columns:
    df['Clean_text'] = df['Binh_luan_goc'].astype(str).str.lower()

df['Chu_de'] = df['Clean_text'].apply(detect_topic)
df['Ten_truong'] = df['Clean_text'].apply(extract_school)
df['Ten_nganh'] = df['Clean_text'].apply(extract_major)
